                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'SI') {
                                await cobrabotconn.sendMessage(cobrabotconn.user.jid, '*⚒ ⦁ දෝෂ වාර්තාව (🪐 SILVER BOT 🪐) ⦁ ⚒ ︎*' + 
                                ...
                                if (error.message.includes('URL')) {
                                    return await cobrabotconn.sendMessage(cobrabotconn.user.jid, '*⚒ ⦁ දෝෂ විසඳුම (🪐 SILVER BOT 🪐) ⦁ ⚒ ︎*' + 
                                        '\n========== ```දෝෂය කියවන්න!``` ==========' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await cobrabotconn.sendMessage(cobrabotconn.user.jid, '* 💱️ ERROR ANALYSIS [🪐 SILVER BOT 🪐]  💱️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
