...
if (Config.WORKTYPE == 'private') {
    ...
    Silver.addCommand({pattern: 'menu ?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
...
var MENUMSG = '*❋ ───── command list ───── ❋*\n\n' + CMD_HELP
var SMENUIMG = await axios.get ('https://i.ibb.co/TTS79KX/Silverbot-Menuimage.jpg', {responseType: 'arraybuffer'})
        await message.client.sendMessage(message.jid, Buffer.from(SMENUIMG.data), MessageType.image, {mimetype: Mimetype.png, caption:MENUMSG })
