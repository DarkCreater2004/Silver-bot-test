...
module.exports = {
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐁𝐘 𝐒𝐈𝐋𝐕𝐄𝐑 𝐁𝐎𝐓 ²⁰²²' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐁𝐘 𝐒𝐈𝐋𝐕𝐄𝐑 𝐁𝐎𝐓< ²⁰²²' : process.env.CAPTION,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? '𝐒𝐈𝐋𝐕𝐄𝐑 𝐃𝐄𝐕' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? '𝐒𝐈𝐋𝐕𝐄𝐑 𝐁𝐎𝐓' : process.env.BOT_NAME,
