...
module.exports = {
    ...
    ANTI_BADS: process.env.ANTI_BADS === undefined ? 'false' : process.env.ANTI_BADS,
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.ibb.co/gVfYW1q/Silver.jpg' : process.env.GAN_IMAGE,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    INBOX_BLOCK: process.env.INBOX_BLOCK === undefined ? 'false' : process.env.INBOX_BLOCK,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.ibb.co/gVfYW1q/Silver.jpg' : process.env.ALIVE_LOGO,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? '[⚓]─⦁ 𝚂𝙸𝙻𝚅𝙴𝚁 𝙱𝙾𝚃 ⦁─[⚓]' : process.env.BOT_NAME,
